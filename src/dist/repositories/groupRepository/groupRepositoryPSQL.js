...
exports.GroupPSQLRepository = exports.sequelize = void 0;
var sequelize_1 = require("sequelize");
var sequelizeModels_1 = require("../sequelizeModels");
exports.sequelize = new sequelize_1.Sequelize(process.env.PSQLConnectionString);
var GroupPSQLRepository = /** @class */ (function () {
    function GroupPSQLRepository() {
        var _this = this;
        this.getGroup = function (groupId) { return __awaiter(_this, void 0, void 0, function () {
            var group;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, sequelizeModels_1.GroupModel.findByPk(groupId)];
                    case 1:
                        group = _a.sent();
        ...
        this.getGroups = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, sequelizeModels_1.GroupModel.findAll({
                            order: [
                                ['name', 'ASC']
                            ]
                        })];
        ...
        this.isNameExists = function (groupName) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, sequelizeModels_1.GroupModel.findOne({
                            where: {
                                name: (_a = {},
        ...
        this.createGroup = function (group) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, sequelizeModels_1.GroupModel.create(group)];
                    case 1:
        ...
        this.updateGroup = function (group) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, sequelizeModels_1.GroupModel.update({
                            name: group.name,
        ...
        this.deleteGroup = function (groupId) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, sequelizeModels_1.GroupModel.destroy({
                                where: {
                                    id: (_a = {},
                        ...
                        return [4 /*yield*/, exports.sequelize.transaction(function (t) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    userIds.forEach(function (userId) { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0: return [4 /*yield*/, sequelizeModels_1.GroupUser.create({
                                                        GroupId: groupId,
                                                        UserId: userId
                                                    })];
                                                case 1:
    ...
    GroupPSQLRepository.createRepository = function () {
        if (!GroupPSQLRepository.repository) {
            GroupPSQLRepository.repository = new GroupPSQLRepository();
        }
        return GroupPSQLRepository.repository;
    };
    return GroupPSQLRepository;
}());
exports.GroupPSQLRepository = GroupPSQLRepository;
;
