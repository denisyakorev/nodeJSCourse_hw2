...
var AuthController = /** @class */ (function () {
    ...
    AuthController.prototype.login = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.getUserByCredentials(req.body.login, req.body.password)];
                    case 1:
                        user = _a.sent();
    ...
    ;
    __decorate([
        (0, inversify_express_utils_1.httpPost)('/', loginValidator_1.loginValidator),
