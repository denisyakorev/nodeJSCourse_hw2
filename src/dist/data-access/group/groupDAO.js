...
var GroupDAO = /** @class */ (function () {
    function GroupDAO() {
        ...
        this.getGroup = function (groupId) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, group_1.GroupModel.findByPk(groupId)];
                    case 1:
                        group = _a.sent();
        ...
        this.getGroups = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, group_1.GroupModel.findAll({
                            order: [
                                ['name', 'ASC']
                            ]
                        })];
        ...
        this.isNameExists = function (groupName) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, group_1.GroupModel.findOne({
                            where: {
                                name: (_a = {},
        ...
        this.createGroup = function (group) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, group_1.GroupModel.create(group)];
                    case 1:
        ...
        this.updateGroup = function (group) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, group_1.GroupModel.update({
                            name: group.name,
        ...
        this.deleteGroup = function (groupId) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, group_1.GroupModel.destroy({
                                where: {
                                    id: (_a = {},
                        ...
                        return [4 /*yield*/, connect_1.sequelize.transaction(function (t) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    userIds.forEach(function (userId) { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0: return [4 /*yield*/, userToGroup_1.GroupUser.create({
                                                        GroupId: groupId,
                                                        UserId: userId
                                                    })];
                                                case 1:
    ...
    GroupDAO_1 = GroupDAO;
    var GroupDAO_1;
    GroupDAO.createRepository = function () {
        if (!GroupDAO_1.repository) {
            GroupDAO_1.repository = new GroupDAO_1();
        }
        return GroupDAO_1.repository;
    };
