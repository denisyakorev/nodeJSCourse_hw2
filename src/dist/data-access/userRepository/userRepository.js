...
exports.userRepository = exports.sequelize = void 0;
...
var userRepository = /** @class */ (function () {
    function userRepository() {
        ...
        this.createUser = function (user) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, EntityModels_1.UserModel.create(user)];
                    case 1:
                        createdUser = _a.sent();
        ...
        this.deleteUser = function (userId) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, EntityModels_1.UserModel.update({ isDeleted: true }, {
                            where: {
                                id: userId,
                            },
                        })];
        ...
        this.getAutoSuggestUsers = function (loginSubstring, limit) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, EntityModels_1.UserModel.findAll({
                            where: {
                                login: (_a = {},
        ...
        this.getUser = function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, EntityModels_1.UserModel.findByPk(id)];
                    case 1:
                        user = _a.sent();
        ...
        this.isLoginExists = function (login) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, EntityModels_1.UserModel.findOne({
                            where: {
                                login: (_a = {},
        ...
        this.updateUser = function (user) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, EntityModels_1.UserModel.update({
                            login: user.login,
    ...
    userRepository.createRepository = function () {
        if (!userRepository_1.repository) {
            userRepository_1.repository = new userRepository_1();
        }
        return userRepository_1.repository;
    };
